...
| `connect` | If only connected blocks from the start should be matched. If false, all blocks, regardless of connection, inside of the region will be checked. | `True/False` | `false` |
