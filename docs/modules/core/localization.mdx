...
id: localization
title: Localization
description: Localization for maps.
---
...
| --------- | --------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| `lang`    | The identifier for the language.                                                                                                  | <span class="badge badge--primary">Language</span><br />[Possible Values](http://www.oracle.com/technetwork/java/javase/java8locales-2095355.html) |
| `country` | The country of the translated text (For example, to use Canadian English, you would define the lang as en and the country as ca). | <span class="badge badge--primary">Country</span><br />[Possible Values](http://www.oracle.com/technetwork/java/javase/java8locales-2095355.html)  |
