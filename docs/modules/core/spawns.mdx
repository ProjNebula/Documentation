...
| `mode` | | `Selection Mode`<br />`random`, `safe`, `spread` | `RANDOM` |
| `ensure-safe` | If each location of the region should be checked to see if it is safe to spawn in. | `True/False` | `false` |
